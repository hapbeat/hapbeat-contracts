...
### 3.4 mode_id とモード別 body（AS-BUILT, 2026-07-08／mode 6 は 2026-07-09 追加）
...
| id | 名前 | codec / fs / ch | frame | pb | RX buffer | 想定遅延(表示) |
|---|---|---|---|---|---|---|
| 0 | **RAW** | IMA-ADPCM 16k **stereo** | 4ms | ×1 | 480f=30ms | 30ms |
| 1 | **FAST** | Opus 8k mono | 5ms | ×1 | 128f=8ms | 10ms |
| 2 | **BALANCED** | Opus 8k mono | 5ms | ×1 | 288f=18ms | 15ms |
| 3 | **SMOOTH** | Opus 8k mono | 10ms | ×2 | 448f=28ms | 28ms |
| 4 | **STEREO** | Opus 8k **stereo** | 10ms | ×1 | 288f=18ms | 18ms |
| 5 | **HIFI** | Opus 16k **stereo** | 10ms | ×2 | 448f=28ms | 28ms |
| 6 | **LITE** | IMA-ADPCM 8k **mono** | 5ms(40f) | ×1 | 未実測（TBD） | 未実測（TBD） |
...
#### mode 6（LITE = ADPCM 8k mono）body
